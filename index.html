	...
	<div class="banner_w3lspvt he-codes">
		<div class="container-fluid">
			<div class="banner-text pl-lg-5 pl-sm-4 ml-lg-3">
				...
				<h1 class="my-md-4 my-3">Travels Management </h1>
				<h2>Complete solution for travel agencies and tour operators.It is a web based travel software that automates your Travel Business.
