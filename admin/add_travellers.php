                              ...
                              <form action="operations/travellers.php" method="post" id="loginForm" enctype="multipart/form-data">
                                    <div class="form-body">
                                      ...
                                      <div class="row">
                                            ...
                                            <option value="Maharashtra">Mombasa</option>
                                            <option value="Gujrat">Nakuru</option>
                                            <option value="Delhi">Delhi</option>
                                            <option value="Bihar">Kampala</option>
                                             <option value="Haryana">Arusha</option>
                                             <option value="Sikkim">Kisumu</option>
                                            <option value="Goa">Naivasha</option>
                                            <option value="Punjab">Nairobi</option>
                                            <option value="Assam">Machakos</option>
                                                    </select>
                                                    </div>
                                            </div>
                                       ...
                                       <label class="control-label">Mobile </label>
                                        <input type="tel" class="form-control"  name="val-digits" placeholder="Enter Your Mobile No."  pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$" maxlength="15"  required>
                                                     </div>
                                            </div>
