...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                  <marquee scrollamount=4><b>Alert, Komolkori Benjamin contact me at 0707687931/kipyegonbiegon@gmail.com.</b></marquee>
                <div class="row">
                    <div class="col-md-3">
 ...
 $xyz = $stmt3->setFetchMode(PDO::FETCH_ASSOC);
      ...
      $payment=$stmt3->fetch(PDO::FETCH_ASSOC);
       ...
       $stmt6 = $conn->prepare("SELECT SUM(insert_amount) as amt from payment where booking_id='".$booking['id']."'"); 
                ...
                <footer class="footer text-center" ><strong><mark>Biegon. </mark></strong>
            <?php
